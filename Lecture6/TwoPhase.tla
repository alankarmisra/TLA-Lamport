...
TMCommit ==
  ...
  (*************************************************************************)
  /\ tmState = "init"
  /\ tmPrepared = RM \* this ensures that a commit message is sent only when every RM is prepared
  /\ tmState' = "done"
...
RMChooseToAbort(r) ==
  ...
  (*************************************************************************)
  /\ rmState[r] = "working"
  /\ rmState' = [rmState EXCEPT ![r] = "aborted"] \* this doesn't go to the prepared state, and so TMCommit won't match, and TMAbort will.
...
\* Last modified Mon Aug 05 16:16:28 WITA 2024 by alankar
\* Created Thu Aug 01 16:10:02 WITA 2024 by alankar
