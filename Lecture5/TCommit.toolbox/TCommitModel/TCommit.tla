...
\* valid_states = {"working", "prepared", "committed", "aborted"}
\*
\* for rm in RM:
\*    assert rmState[rm] in valid_states, f"Invalid state for resource manager {rm}: {rmState[rm]}"    
TCTypeOK == 
  (*************************************************************************)
...
Prepare(r) == /\ rmState[r] = "working"
              /\ rmState' = [rmState EXCEPT ![r] = "prepared"] \* Read this as "Exactly as rmState EXCEPT rmState[r] is now "prepared"

Decide(r)  == \/ /\ rmState[r] = "prepared"
                 /\ canCommit
                 /\ rmState' = [rmState EXCEPT ![r] = "committed"] \* Read this as "Exactly as rmState EXCEPT rmState[r] is now "committed"
...
\* Last modified Sat Aug 03 18:57:56 WITA 2024 by alankar
\* Created Sun Jul 28 21:52:06 WITA 2024 by alankar
